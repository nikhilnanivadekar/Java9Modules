...
import robotics.maze.projection.MazeMap;
...
public class ParsingAndDrawingTestMain
{
    public static void main(String[] args)
    {
        ...
        JpegImageWrapper imageWrapper = JpegImageWrapper.loadFile("C:/IntelliJ_Workspace/Java9Modules/Java9Modules/904462610669608960.jpg");
